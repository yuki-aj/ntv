...
<head>
  ...
  <title>Withdraw | northvolt investment</title>
    ...
    <aside class="sidebar" id="sidebar">
      <nav class="sidebar-nav">
        <ul id="sidebarnav" class="sidebar-list">
          ...
          <li class="sidebar-item selected"><a class="sidebar-link transition-opacity" href="/withdraw"><span class="hide-menu">Withdraw</span></a></li>
    ...
    <div class="page-wrapper">
      <div class="contents">
        <div class="row">
          <div class="card">
            <div class="card-text">
              <h5 class="">Latest Withdraw</h5>
              <p class="">฿0.00000000</p>
            </div>
          </div>
          <div class="card">
            <div class="card-text">
              <h5 class="">Overall Withdraw</h5>
              <p class="">฿0.00000000</p>
            </div>
          </div>
          <div class="card">
            <div class="card-text">
              <h5 class="">Unsettle Withdraw</h5>
              <p class="">฿0.00000000</p>
            </div>
          </div>
        </div>
        <div class="row-long">
          <div class="card">
            <h3 class="card-title border-none">Request for Withdraw</h3>
            <dl class="card-body">
              <dt>Available Amount : ฿</dt>
              <dd>0.00000000</dd>
            </dl>
            <div class="card-footer">
              <form class="" id="withdraw" action="" method="POST">
                <div class="form-group">
                  <label for="submit_amount">Withdraw Amount*</label>
                  <input type="text" name="" id="submit_amount" placeholder="Input Amount" class="form-control">
                </div>
                <div class="form-group">
                  <label for="submit_amount">Payment Method*</label>
                  <select class="form-control form-control-line" disabled="disabled">
                    <option value="38" selected="selected">Bitcoin</option>
                  </select>
                </div>
                <div class="form-group form-cen">
                  <button type="submit" id="submit_button" class="form-btn">Submit</button>
                </div>
              </form>
            </div>
          </div>
