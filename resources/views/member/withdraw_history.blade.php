...
<head>
  ...
  <title>Withdraw-history | northvolt investment</title>
  ...
  <main class="main">
    <aside class="sidebar" id="sidebar">
      <nav class="sidebar-nav">
        <ul id="sidebarnav" class="sidebar-list">
          ...
          <li class="sidebar-item selected"><a class="sidebar-link transition-opacity" href="/withdraw_history"><span class="hide-menu">Withdraw History</span></a></li>
        </ul>
      </nav>
    </aside>
    <div class="page-wrapper">
      <div class="contents">
        <div class="row-long">
          <div class="card">
            <h3 class="card-title border-none">Withdraw History</h3>
