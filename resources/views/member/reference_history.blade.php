...
<head>
  ...
  <title>Reference-history | northvolt investment</title>
  ...
  <main class="main">
    <aside class="sidebar" id="sidebar">
      <nav class="sidebar-nav">
        <ul id="sidebarnav" class="sidebar-list">
          ...
          <li class="sidebar-item selected"><a class="sidebar-link transition-opacity" href="/reference_history"><span class="hide-menu">Reference History</span></a></li>
    ...
    <div class="page-wrapper">
      <div class="contents">
        <div class="row-long">
          <div class="card">
            <h3 class="card-title border-none">Referral History</h3>
