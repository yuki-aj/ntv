    ...
    <div class="border" style="margin-bottom: 5%;">    
        ...
        <div class="under-line">
            <div class="flexbox space-between padding3 cart-box" style="flex-wrap:wrap;">
                ...
                <div class="">
                    ...
                    <div class="flexbox space-between">
                        <p>商品合計</p>
                        <p class="f_size24"><span>{{number_format($new_product['total'])}}</span>円</p>
                    </div>
                </div>
            </div>
        ...
        <section class="cf">
            <div class="priceBox p_0 total-price">
                <div class="padding3">
                    @if($summary <= 1500)
                    <div class="text-right" >店舗合計(送料375円込)<span>{{number_format($summary + 375)}}</span>円</div>
                    @elseif($summary >= 3000)
                    <div class="text-right">店舗合計(送料750円込)<span>{{number_format($summary + 750)}}</span>円</div>
                    @else
                    <div class="text-right">店舗合計(送料25%込)<span>{{number_format($summary + $summary*0.25)}}</span>円</div>
                    @endif
                    <div class="">
