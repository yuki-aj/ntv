...
class FilesRequest extends FormRequest{
  ...
  public function rules(){
    ...
    switch ($route) {
      ...
      $rules['wechat_url'] = 'file|image|mimes:jpeg,jpg,png,gif|max:2048';// 2MB(2048)
      $rules['line_url']   = 'file|image|mimes:jpeg,jpg,png,gif|max:2048';// 2MB(2048)
      break;
      case 'edit_product':
      $rules['img_url1'] = 'file|image|mimes:jpeg,jpg,png,gif|max:2048';// 2MB(2048)
      $rules['img_url2'] = 'file|image|mimes:jpeg,jpg,png,gif|max:2048';// 2MB(2048)
      $rules['img_url3'] = 'file|image|mimes:jpeg,jpg,png,gif|max:2048';// 2MB(2048)
      break;
    }
    return $rules;
  }
  public function messages(){
    ...
    // if($locale == 'ja'){
    //   return [
    //     'img_url.uploaded' => '画像サイズが大きすぎます。画像を変更して再登録してください。',
    //   ];
    // }else{
    //   return [
    //     'img_url.uploaded' => 'other languages',
    //   ];
