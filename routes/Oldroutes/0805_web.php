...
Route::match(['get','post'],'/store_manage','ManageController@ShopManage');// もしもし店舗管理　
...
Route::match(['get'       ],'/edit/{c_id}','ManageController@CategoryEdit');// カテゴリー　編集　
Route::match([      'post'],'/edit','ManageController@CategoryEdit');// カテゴリー　編集
...
Route::match(['get'       ],'/categorydelete/{c_id}','ManageController@Categorydelete');// カテゴリー削除
...
Route::match(['get','post'],'/add_store_user','AccountController@AddStoreUser');//追加
