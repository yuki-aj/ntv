...
Route::match(['get','post'],'/shop_manage','ManageController@ShopManage');// もしもし店舗管理　
Route::match(['get'       ],'/product_list','SiteController@Productlist');// 店舗情報
Route::match(['get'       ],'/shop_edit','SiteController@Shopedit');// 商品編集　
Route::match(['get'       ],'/option','SiteController@Option');// オプション編集　
...
Route::match(['get'       ],'/news_edit','ManageController@NewsEdit');// admin お知らせ
Route::match(['get'       ],'/news_edit','ManageController@NewsEdit');
...
// 店舗追加・編集
Route::match(['get'       ],'/shop_information','ManageController@ShopInformation');
Route::match(['get'       ],'/shop_information/{s_id}','ManageController@ShopInformation');
...
Route::match(['get'       ],'/category_delete/{c_id}','ManageController@Categorydelete');// カテゴリー削除

Route::match(['get'       ],'/calendar/{s_id}','SiteController@Calendar');// カレンダー機能
Route::match([      'post'],'/calendar','SiteController@Calendar');// カレンダー機能
...
// 店舗追加
// Route::match([      'post'],'/shop_management', 'EditController@EditProduct');
// // オプション登録
// Route::match([      'post'],'/shop_management', 'EditController@EditOption');
// // 商品一覧
