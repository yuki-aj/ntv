...
Route::match(['get','post'],'/search','SiteController@Search');// 入力検索　追加
...
// 商品追加
Route::match([      'post'],'/product_edit', 'EditController@EditUser');


//stripe
Route::match(['get','post'],'/top2','HomeController@Top2');
