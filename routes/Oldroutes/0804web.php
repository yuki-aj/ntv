...
Route::match(['get','post'],'/moshidelimanagement','SiteController@Moshidelimanagement');// もしもし店舗管理　
...
// 店舗追加・編集
Route::match(['get'       ],'/store_management/{s_id}','SiteController@Shopmanagement');
Route::match([      'post'],'/store_management','SiteController@Shopmanagement');
Route::match(['get'       ],'/store_delete/{s_id}','SiteController@Storedelete');// 店舗削除
// 商品追加・編集
Route::match(['get'       ],'/product_edit/{p_id}','SiteController@Productedit');
Route::match([      'post'],'/product_edit','SiteController@Productedit');
Route::match(['get'       ],'/product_delete/{p_id}','SiteController@Productdelete');// 商品削除
